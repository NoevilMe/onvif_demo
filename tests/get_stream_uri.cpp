...
void ONVIF_DetectDevice(void (*cb)(char *DeviceXAddr)) {
    ...
    result = soap_send___wsdd__Probe(soap, SOAP_MCAST_ADDR, NULL,
                                     &req); // 向组播地址广播Probe消息
...
int main(int argc, char **argv) {
    ...
    // ONVIF_GetServices("http://10.10.10.103/onvif/device_service");
    // ONVIF_GetDeviceInformation("http://10.10.10.104/onvif/device_service")  ;
